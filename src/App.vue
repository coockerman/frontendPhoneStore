...
export default {
  ...
  methods: {
    navigateTo(section) {
      // Dựa vào giá trị của section, bạn có thể thực hiện chuyển hướng đến các trang khác nhau.
      // Ví dụ: nếu section là 'products', chuyển hướng đến trang quản lý sản phẩm.
      if (section === "products") {
        // Thực hiện chuyển hướng, ví dụ:
        this.$router.push({ name: "productManagement" }); // Sử dụng tên route tương ứng của bạn
      } else if (section === "customers") {
        // Thực hiện chuyển hướng đến trang quản lý khách hàng
      } else if (section === "statistics") {
        // Thực hiện chuyển hướng đến trang thống kê
      }
    },
    async getPhones() {
      try {
